...
import { BADGE_TYPE, ICON_POSITION, BUTTON_TYPE } from '~/common/constants/general.constants'
import { SIZE } from '~/common/constants/size.constants'

import {
	ActorReadMore,
	StyledActorReadMore,
} from '~/common/components/actor-read-more/actor-read-more'
import { Badges, StyledBadges } from '~/common/components/badges/badges'
import { Button } from '~/common/components/button/button'
import { IActor, IBadge } from '~/features/actors/models/actor.models'
